            ...
            <div id="page-wrapper">
                ...
                <div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
                    ...
                    <ol class="breadcrumb page-breadcrumb pull-right">
                        <li><i class="fa fa-home"></i>&nbsp;<a href="http://themifycloud.com/demos/templates/KAdmin/KAdmin-Dark/dashboard.html">Home</a>&nbsp;&nbsp;<i class="fa fa-angle-right"></i>&nbsp;&nbsp;</li>
                        <li class="hidden"><a href="http://themifycloud.com/demos/templates/KAdmin/KAdmin-Dark/dashboard.html#">Sales</a>&nbsp;&nbsp;<i class="fa fa-angle-right"></i>&nbsp;&nbsp;</li>
                        ...
                        <form action="#" method="post">
                            <div class="panel">
                                  <div style="width: 100%; height: 400px; overflow-y: scroll;">
                                      <table id="table-left" class="table">
                                      <thead>
                                          <tr style="background: #3C3C3C;color: white;width: 100%;">
                                              <th>Product Name</th>
                                              <th>Price</th>
                                              <th>Quantity</th>
                                              <th>Total</th>
                                      ...
                                      <?php 
                                        ...
                                        if(isset($_GET['id'])) {
                                        $txt= $_GET['id'];
                                        $result = mysqli_query($con,"SELECT * FROM medicine where id=" . $txt);
                                        ...
                                        echo '
                                             ...
                                             <td><input type="text" name="quantity" id="quantity" value="1" style="text-align: center;width:60px;"></td>
                                  ...
                                  <div style="margin-top: 20px;">
                                      <table id="table-down" class="table">
                                      <tr style="background: #3C3C3C;color: white;width: 100%;">
                                  ...
                                  <button class="btn btn-success" style="width: 100%;padding: 20px;font-size: 20px;">Purchase <i class="fa fa-shopping-cart"></i></button>
                                  </div>
                            </div>
                        </form>
                    </div>
                    ...
                    <div class="col-sm-7">
                        <form action="#" method="post">
                                <div class="input-group">
                                  ...
                                  $query = mysqli_query($connection,"Select * from medicine where deleted = 0");
                                  while($row = mysqli_fetch_assoc($query))
                                  {
                                    echo '<div class="col-md-3">                        
                                    <a href="Sales.php?id='.$row['id'].'" class="tile tile-success tile-valign" name="tanginamo">
                                    '.$row['name'].'
                                    <br>'.$row['category'].'
                                    <br>'.$row['quantity'].'
                                    </a>
